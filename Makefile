...
DEF-armv8m        = $(DEF-arm-eabihf) -DTCC_TARGET_ARM_THUMB -DTCC_TARGET_ARM_ARMV8M
...
CORE_FILES = tcc.c tcctools.c libtcc.c tccpp.c tccgen.c tccdbg.c tccelf.c tccasm.c 
...
armv8m_FILES = $(CORE_FILES) arm-thumb-gen.c arm-link.c arm-thumb-asm.c
