...
/* Drop phi operands coming from blocks a branch fold left unreachable.  Any
 ...
 * Returns the number of loops rotated.  See source/opt/ssa/loop/loop_rotate.c. */
 ...
 * See source/opt/ssa/loop/first_iter_exit.c. */
 ...
 * stack-slot materialization into per-arm ORs (engine in source/opt/ssa/cfg/or_bool_diamond.c).
