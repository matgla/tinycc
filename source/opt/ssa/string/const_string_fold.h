...
/* Same folder, run on flat IR before the SSA-region loop transforms: a call
 * folded to an immediate there lets LICM/rotation see the final loop body. */
int tcc_ir_ssa_opt_const_string_fold_flat(struct TCCIRState *ir);
