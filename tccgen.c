...
static PendingAliasDef *pending_aliases;
static int nb_pending_aliases;
...
static int try_fold_complex_call(const char *func_name, SValue *args, int nb_args)
{
  if (nb_args != 1)
    return 0;
...
static void check_nonvoid_value(void)
{
