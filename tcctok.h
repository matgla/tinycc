...
// integer division functions for ARM EABI
// DEF(TOK___divsi3, "__aeabi_idiv")
// DEF(TOK___udivsi3, "__aeabi_uidiv")

// floating point functions for ARM EABI
...
#define TOK___fixunssfdi TOK___aeabi_f2ulz
#define TOK___fixunsdfdi TOK___aeabi_d2ulz
DEF(TOK___aeabi_dadd, "__aeabi_dadd")
DEF(TOK___aeabi_ddiv, "__aeabi_ddiv")
DEF(TOK___aeabi_dmul, "__aeabi_dmul")
DEF(TOK___aeabi_drsub, "__aeabi_drsub")
DEF(TOK___aeabi_dsub, "__aeabi_dsub")
DEF(TOK___aeabi_cdcmpeq, "__aeabi_cdcmpeq")
DEF(TOK___aeabi_cdcmple, "__aeabi_cdcmple")
DEF(TOK___aeabi_cdrcmple, "__aeabi_cdrcmple")
DEF(TOK___aeabi_dcmpeq, "__aeabi_dcmpeq")
DEF(TOK___aeabi_dcmpne, "__aeabi_dcmpne") // temporary
DEF(TOK___aeabi_dcmplt, "__aeabi_dcmplt")
DEF(TOK___aeabi_dcmple, "__aeabi_dcmple")
DEF(TOK___aeabi_dcmpge, "__aeabi_dcmpge")
DEF(TOK___aeabi_dcmpgt, "__aeabi_dcmpgt")
DEF(TOK___aeabi_dcmpun, "__aeabi_dcmpun")
DEF(TOK___aeabi_fadd, "__aeabi_fadd")
DEF(TOK___aeabi_fdiv, "__aeabi_fdiv")
DEF(TOK___aeabi_fmul, "__aeabi_fmul")
DEF(TOK___aeabi_frsub, "__aeabi_frsub")
DEF(TOK___aeabi_fsub, "__aeabi_fsub")
DEF(TOK___aeabi_fcmpeq, "__aeabi_fcmpeq")
DEF(TOK___aeabi_cfcmpne, "__aeabi_fcmpne")


// DEF(TOK___aeabi_cfcmple, "__aeabi_cfcmple")
// DEF(TOK___aeabi_cfrcmple, "__aeabi_cfrcmple")
// DEF(TOK___aeabi_fcmpeq, "__aeabi_fcmpeq")
DEF(TOK___aeabi_fcmplt, "__aeabi_fcmplt")
DEF(TOK___aeabi_fcmple, "__aeabi_fcmple")
DEF(TOK___aeabi_fcmpge, "__aeabi_fcmpge")
DEF(TOK___aeabi_fcmpgt, "__aeabi_fcmpgt")
// DEF(TOK___aeabi_fcmpun, "__aeabi_fcmpun")
DEF(TOK___aeabi_d2iz, "__aeabi_d2iz")
DEF(TOK___aeabi_d2uiz, "__aeabi_d2uiz")
DEF(TOK___aeabi_d2lz, "__aeabi_d2lz")
DEF(TOK___aeabi_d2ulz, "__aeabi_d2ulz")
DEF(TOK___aeabi_f2iz, "__aeabi_f2iz")
DEF(TOK___aeabi_f2uiz, "__aeabi_f2uiz")
DEF(TOK___aeabi_f2lz, "__aeabi_f2lz")
DEF(TOK___aeabi_f2ulz, "__aeabi_f2ulz")
// DEF(TOK___aeabi_d2f, "__aeabi_d2f")
// DEF(TOK___aeabi_f2d, "__aeabi_f2d")
// DEF(TOK___aeabi_h2f, "__aeabi_h2f")
// DEF(TOK___aeabi_h2f_alt, "__aeabi_h2f_alt")
// DEF(TOK___aeabi_f2h, "__aeabi_f2h")
// DEF(TOK___aeabi_f2h_alt, "__aeabi_f2h_alt")
// DEF(TOK___aeabi_d2h, "__aeabi_d2h")
// DEF(TOK___aeabi_d2h_alt, "__aeabi_d2h_alt")
// DEF(TOK___aeabi_i2d, "__aeabi_i2d")
// DEF(TOK___aeabi_ui2d, "__aeabi_ui2d")
DEF(TOK___aeabi_l2d, "__aeabi_l2d")
// DEF(TOK___aeabi_ul2d, "__aeabi_ul2d")
// DEF(TOK___aeabi_i2f, "__aeabi_i2f")
// DEF(TOK___aeabi_ui2f, "__aeabi_ui2f")
// DEF(TOK___aeabi_l2f, "__aeabi_l2f")
// DEF(TOK___aeabi_ul2f, "__aeabi_ul2f")
// DEF(TOK___aeabi_lmul, "__aeabi_lmul")
DEF(TOK___aeabi_ldivmod, "__aeabi_ldivmod")
DEF(TOK___aeabi_uldivmod, "__aeabi_uldivmod")
// DEF(TOK___aeabi_llsl, "__aeabi_llsl")
// DEF(TOK___aeabi_llsr, "__aeabi_llsr")
// DEF(TOK___aeabi_lcmp, "__aeabi_lcmp")
// DEF(TOK___aeabi_ulcmp, "__aeabi_ulcmp")
// DEF(TOK___aeabi_idiv, "__aeabi_idiv")
// DEF(TOK___aeabi_uidiv, "__aeabi_uidiv")
DEF(TOK___aeabi_idivmod, "__aeabi_idivmod")
DEF(TOK___aeabi_uidivmod, "__aeabi_uidivmod")
// DEF(TOK___aeabi_idiv0, "__aeabi_idiv0")
// DEF(TOK___aeabi_ldiv0, "__aeabi_ldiv0")
#else
