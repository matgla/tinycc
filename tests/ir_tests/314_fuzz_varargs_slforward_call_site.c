/* Regression for fuzz triage seed 155856: stack/local forwarding around a
 * variadic call site must not stale-fold values used by the checksum.
 *
 * AUTO-GENERATED by tests/fuzz/gen_c.py  seed=155856
 */
#include <stdio.h>
#include <stdarg.h>
