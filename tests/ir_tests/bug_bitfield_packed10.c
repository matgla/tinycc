...
int main(void)
{
    ...
    for (int i = 0; i < 4; i++) {
        ...
        switch (i) {
            case 0: expected_tag = 1; expected_payload = 100; break;
            case 1: expected_tag = 7; expected_payload = 200; break;
            case 2: expected_tag = 2; expected_payload = 0x10000; break;
            case 3: expected_tag = 5; expected_payload = 300; break;
        }
        if (t != expected_tag) {
