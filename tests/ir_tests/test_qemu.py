...
TEST_FILES = [
    ...
    # ("../tests2/60_errors_and_warnings.c", 0),
    # ("../tests2/61_integers.c", 0),
    # ("../tests2/64_macro_nesting.c", 0),
    # ("../tests2/67_macro_concat.c", 0),
    # # ("../tests2/70_floating_point_literals.c", 0),  # float support
    ...
    # # ("../tests2/84_hex-float.c", 0),  # float support
    ...
    # ("../tests2/109_float_struct_calling.c", 0),  # float support
    # ("../tests2/110_average.c", 0),  # float support
    # ("../tests2/111_conversion.c", 0),  # float support
    ...
    # ("../tests2/134_double_to_signed.c", 0),  # double support
