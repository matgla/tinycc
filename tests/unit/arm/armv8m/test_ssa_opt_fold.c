...
UT_SUITE(ssa_opt_fold)
{
  ...
  UT_RUN(test_fold_absorb_or_minus_one_opaque);
  UT_RUN(test_fold_absorb_shift_zero_src);
  UT_RUN(test_fold_identity_div_one);
  UT_RUN(test_fold_absorb_mod_one);
  UT_RUN(test_fold_div_minus_one_to_rsb);
  UT_RUN(test_fold_xor_cancel_vreg);
  UT_RUN(test_fold_xor_cancel_double_complement);
  UT_RUN(test_fold_xor_cancel_no_match);
  UT_RUN(test_fold_xor_cancel_multidef_y_no_fold);
  UT_RUN(test_fold_absorption_and_or);
  UT_RUN(test_fold_absorption_or_and_swapped);
  UT_RUN(test_fold_absorption_no_shared_arm);
  UT_RUN(test_fold_shift_chain_merge);
  UT_RUN(test_fold_shift_chain_overflow_and_sar_saturate);
